...
add_action('init', function (): void {
    $labels = [
        'name'                  => _x('Content Hub', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Content Hub', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Content Hub', 'flynt'),
        'name_admin_bar'        => __('Content Hub', 'flynt'),
...
// Register Options
Options::addGlobal('ContentHub', [
    [
        'label' => __('Content Hub Archive Page', 'flynt'),
        'name' => 'contenthubArchivePage',
        'type' => 'post_object',
        'return_format' => 'id',
    ],
]);