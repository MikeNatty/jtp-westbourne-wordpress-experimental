...
add_action('init', function (): void {
    $labels = [
        'name'                  => _x('Leadership', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Leadership', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Leadership', 'flynt'),
        'name_admin_bar'        => __('Leadership', 'flynt'),
//        'archives'              => __('Item Archives', 'flynt'),
//        'attributes'            => __('Item Attributes', 'flynt'),
        'parent_item_colon'     => __('Parent Item:', 'flynt'),
        'all_items'             => __('All Leadership', 'flynt'),
        'add_new_item'          => __('Add New Leadership', 'flynt'),
        'add_new'               => __('Add Leadership', 'flynt'),
        'new_item'              => __('New Leadership', 'flynt'),
        'edit_item'             => __('Edit Leadership', 'flynt'),
        'update_item'           => __('Update Leadership', 'flynt'),
