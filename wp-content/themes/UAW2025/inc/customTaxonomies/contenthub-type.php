...
add_action('init', function (): void {
    $labels = [
        'name'                       => _x('Article Types', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Article Type', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Article Type', 'flynt'),
    ...
    register_taxonomy('contenthub-type', ['contenthub'], $args);
});
