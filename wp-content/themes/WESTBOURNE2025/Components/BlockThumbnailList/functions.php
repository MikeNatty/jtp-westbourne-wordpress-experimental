...
namespace Flynt\Components\BlockThumbnailList;
...
add_filter('Flynt/addComponentData?name=BlockThumbnailList', function ($data) {
    ...
    error_log( 'BlockThumbnailList data: ' . print_r($data, true) );
...
//            ],
            ...
            [
                ...
                'sub_fields' => [
                    ...
                    [
                        'label' => __('Selected Publications', 'flynt'),
                        'name' => 'selectedPosts',
                        // 'instructions' => 'Select up to 9 related posts here.',
                        'type' => 'post_object',
                        'post_type' => [
...
//                    ],
            ...
            [
                ...
                'name' => 'variant',
                'type' => 'button_group',
                'instructions' => 'Variant 1: Card headings only.<br>Variant 2: Cards with heading and subhead.<br>Variant 3: Title and full-width carousel, cards with headings and subhead.',
                'other_choice' => 0,
                'save_other_choice' => 0,
                'layout' => 'horizontal',
                'choices' => [
