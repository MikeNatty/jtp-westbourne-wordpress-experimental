...
namespace Flynt\Components\BlockPromoBanner;

use Flynt\FieldVariables;
use Flynt\Utils\Options;

add_filter('Flynt/addComponentData?name=BlockPromoBanner', function (array $data): array {
    return $data;
});
...
{
    return [
        'name' => 'blockPromoBanner',
        'label' => __('Promo Banner', 'flynt'),
        'sub_fields' => [
            [
