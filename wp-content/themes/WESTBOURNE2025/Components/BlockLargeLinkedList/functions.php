...
namespace Flynt\Components\BlockLargeLinkedList;
...
add_filter('Flynt/addComponentData?name=BlockLargeLinkedList', function ($data) {
    ...
    error_log( 'BlockLargeLinkedList data: ' . print_r($data, true) );
