...
add_action('init', function (): void {
    $labels = [
        'name'                       => _x('Article Categories', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Article Category', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Article Category', 'flynt'),
    ...
    register_taxonomy('contenthub-category', ['contenthub'], $args);
});
