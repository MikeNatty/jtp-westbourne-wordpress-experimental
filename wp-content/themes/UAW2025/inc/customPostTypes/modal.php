...
add_action('init', function (): void {
    $labels = [
        'name'                  => _x('Modal Content', 'Post Type General Name', 'flynt'),
        'singular_name'         => _x('Modal Content', 'Post Type Singular Name', 'flynt'),
        'menu_name'             => __('Modal Content', 'flynt'),
        'name_admin_bar'        => __('Modal Content', 'flynt'),
        'archives'              => __('Item Archives', 'flynt'),
        'attributes'            => __('Item Attributes', 'flynt'),
        'parent_item_colon'     => __('Parent Item:', 'flynt'),
        'all_items'             => __('All Modal Content', 'flynt'),
        'add_new_item'          => __('Add New Modal Content', 'flynt'),
        'add_new'               => __('Add Modal Content', 'flynt'),
        'new_item'              => __('New Modal Content', 'flynt'),
        'edit_item'             => __('Edit Modal Content', 'flynt'),
        'update_item'           => __('Update Modal Content', 'flynt'),
        'view_item'             => __('View Modal Content', 'flynt'),
        'view_items'            => __('View Modal Content', 'flynt'),
        'search_items'          => __('Search Modal Content', 'flynt'),
