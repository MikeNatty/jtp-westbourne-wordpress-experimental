...
namespace Flynt\Components\BlockContentFullWidth;

use Flynt\FieldVariables;

add_filter('Flynt/addComponentData?name=BlockContentFullWidth', function ($data) {
    return $data;
});
...
{
    return [
        'name' => 'blockContentFullWidth',
        'label' => __('Content Full Width', 'flynt'),
        'sub_fields' => [
            [
