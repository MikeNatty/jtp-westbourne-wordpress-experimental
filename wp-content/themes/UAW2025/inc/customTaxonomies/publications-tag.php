...
add_action('init', function (): void {
    $labels = [
        'name'                       => _x('Publications Tags', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Publications Tag', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Publications Tag', 'flynt'),
    ...
    register_taxonomy('publications-tag', ['publications'], $args);
});
