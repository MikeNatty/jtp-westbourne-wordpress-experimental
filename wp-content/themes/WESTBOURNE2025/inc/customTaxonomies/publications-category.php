...
add_action('init', function (): void {
    $labels = [
        'name'                       => _x('Publications Categories', 'Taxonomy General Name', 'flynt'),
        'singular_name'              => _x('Publications Category', 'Taxonomy Singular Name', 'flynt'),
        'menu_name'                  => __('Publications Category', 'flynt'),
    ...
    register_taxonomy('publications-category', ['publications'], $args);
});
